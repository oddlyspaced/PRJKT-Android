...
//        }
    ...
    private fun render() {
        for (icon in icons) {
            ...
            ColorPickerFragment.applyForegroundGradient(binding.imgIconForeground, iconProperties.foregroundStartColor, iconProperties.foregroundEndColor, iconProperties.foregroundAngle)
            renderIcon("$icon")
        }
